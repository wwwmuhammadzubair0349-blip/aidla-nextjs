...
export async function generateMetadata({ searchParams }) {
  ...
  // Language
  if (language) {
    const langLabel = language === "Arabic (عربي)" ? "Arabic" : language === "Urdu (اردو)" ? "Urdu" : language;
    return {
  ...
  return {
    ...
    keywords: [
      ...
      "multilingual email AI", "Pakistan email writer", "UAE business email",
      ...
      "best email generator for job seekers", "career email tool Pakistan"
    ].join(", "),
    robots: {
      index: true,
      follow: true,
    ...
    alternates: {
      ...
      languages: {
        ...
        "ur-PK": "https://www.aidla.online/tools/ai/email-writer?language=Urdu%20(اردو)",
        "ar-AE": "https://www.aidla.online/tools/ai/email-writer?language=Arabic%20(عربي)",
      },
    },
    openGraph: {
      title: "Free AI Email Writer 2026 — Better Than Grammarly | No Sign-Up | AIDLA",
      description: "AI writes professional emails in seconds. 24 types, 6 tones, 11 languages. Opens in Gmail, Outlook, Yahoo. 100% free forever — no $12/mo subscription. Pakistan, UAE, GCC & global.",
      type: "website",
    ...
    other: {
      ...
      "DC.title": "Free AI Email Writer 2026 — Professional Email Generator | AIDLA Pakistan",
      "DC.description": "AI-powered email writer with 24 types, 6 tones, 11 languages. Free alternative to Grammarly. Opens in Gmail, Outlook. For Pakistan, UAE, GCC & worldwide.",
...
function EmailWriterJsonLd() {
  ...
  const softwareAppSchema = {
    ...
    description: "AI-powered email writer generating professional, business, personal, and academic emails in seconds. 24 email types, 6 tones (Professional, Formal, Friendly, Persuasive, Empathetic, Concise), 11 languages including Urdu and Arabic. One-click open in Gmail, Outlook, Yahoo. 100% free forever — better than Grammarly's $12/month plan for career-focused email writing. No sign-up required. Optimized for Pakistan (HEC, Rozee.pk), UAE (MOHRE, Bayt.com), and GCC job markets.",
    url: pageUrl,
...
const ANSWER_BLOCKS = [
  ...
  },
  {
    ...
    answer: "For Urdu business emails: (1) Formal opening — 'السلام علیکم' (Assalam-o-Alaikum) or 'محترم جناب' (Respected Sir), (2) State purpose clearly in polite Urdu, (3) Use appropriate تہذیب (tehzeeb) — respectful vocabulary and honorifics, (4) Include contact details in both Urdu and English, (5) Formal closing — 'آپ کا مخلص' or 'خدا حافظ۔' AIDLA generates complete Urdu emails from English context — select Urdu from Language dropdown, Professional tone.",
...
const GRAMMARLY_COMPARISON = [
  ...
  { feature: "Languages", aidla: "✅ 11 (Urdu, Arabic +)", grammarly: "⚠️ English only" },
  { feature: "Regional Templates (PK/UAE)", aidla: "✅ HEC, MOHRE, Rozee.pk", grammarly: "❌ None" },
  { feature: "Gmail/Outlook Integration", aidla: "✅ One-click open", grammarly: "⚠️ Browser extension" },
  { feature: "AI Prompts", aidla: "✅ Unlimited free", grammarly: "⚠️ 100 (Free), 2,000 ($12/mo)" },
    ...
    content: (
      <>
        ...
        <p>
          ...
          فصحى (Fusha) or formal business Arabic suitable for GCC professional contexts. For multilingual professionals switching between 
...
const EMAIL_LANGUAGES_LIST = ["English", "Arabic (عربي)", "Urdu (اردو)", "French", "Spanish", "German", "Hindi", "Portuguese", "Turkish", "Chinese", "Japanese"];
    ...
    <>
      ...
      >
        <article itemScope itemType="https://schema.org/Article">
          ...
          <h3 style={{ fontSize: "1.2rem", fontWeight: 800, color: "#0b1437", marginBottom: 16 }}>🎙️ Tone Options — Match Every Situation</h3>
          <div style={{ display: "flex", flexWrap: "wrap", gap: 8, marginBottom: 36 }}>
