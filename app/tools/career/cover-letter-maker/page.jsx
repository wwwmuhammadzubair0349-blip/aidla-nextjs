...
export async function generateMetadata({ searchParams }) {
  ...
  return {
    ...
    openGraph: {
      ...
      description:
        "AI-powered cover letter maker with 6 templates, per-field AI writing, live A4 preview and PDF print. 100% free, no sign-up. Perfect for global jobs. Better than paid tools.",
      type: "website",
    ...
    other: {
      ...
      "DC.title": "Free Cover Letter Maker 2026 � AI Job Application Letters | AIDLA",
      "DC.description":
        "AI-powered cover letter builder with 6 templates, per-field AI writing, live preview, PDF. Free for global job seekers. No sign-up.",
      "DC.subject":
