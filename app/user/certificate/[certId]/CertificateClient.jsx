...
export default function CertificateClient() {
  ...
  if (error) return (
    <div style={{ display:'flex',height:'100vh',alignItems:'center',justifyContent:'center',flexDirection:'column',gap:12,fontFamily:'system-ui',background:C.bg }}>
      ...
      <Link href="/courses" style={{ background:C.blue,color:C.white,padding:'10px 22px',borderRadius:8,textDecoration:'none',fontWeight:700 }}>← Back to Courses</Link>
    </div>
  );
    ...
    <>
      ...
      <div className="cert-page">
        <div className="toolbar">
          ...
          <Link href="/user" className="tb-el tb-back">← Dashboard</Link>
