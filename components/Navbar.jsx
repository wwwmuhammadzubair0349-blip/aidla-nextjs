...
const Icons = {
  ...
  Projects: <svg viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round"><path d="M12 3 2 8l10 5 10-5-10-5Z"/><path d="m2 17 10 5 10-5"/><path d="m2 12 10 5 10-5"/></svg>,
...
},
{
  ...
  subItems: [
    ...
    { href: "/projects", label: "Projects", desc: "Explore project ideas & FYP help.", icon: Icons.Projects },
  ]
},
